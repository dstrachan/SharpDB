...
public interface IDateAtomSubtractionOperators : ISubtractionOperators<DateAtom, ByteAtom, DateAtom>,
    ...
    ISubtractionOperators<DateAtom, LongVector, DateVector>, ISubtractionOperators<DateAtom, FloatAtom, DateAtom>,
    ISubtractionOperators<DateAtom, FloatVector, DateVector>, ISubtractionOperators<DateAtom, DateAtom, IntAtom>,
    ISubtractionOperators<DateAtom, DateVector, IntVector>, ISubtractionOperators<DateAtom, TimespanAtom, TimestampAtom>,
    ...
    ISubtractionOperators<DateAtom, SecondAtom, TimestampAtom>, ISubtractionOperators<DateAtom, SecondVector, TimestampVector>
{
}
